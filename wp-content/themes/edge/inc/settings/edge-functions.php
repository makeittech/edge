...
function edge_scripts() {
	...
	wp_enqueue_style('sofiapro', get_template_directory_uri().'/fonts/sofiapro/stylesheet.css');
	wp_enqueue_style('bootstrap', get_template_directory_uri().'/css/bootstrap.min.css');
//	wp_enqueue_style('jquery-ui', get_template_directory_uri().'/assets/jquery-ui/jquery-ui.css');
	...
	wp_enqueue_script('jquery-ui', get_template_directory_uri().'/assets/jquery-ui/jquery-ui.js', array('jquery_cycle_all'), false, true);
	wp_enqueue_script('form-validate', get_template_directory_uri().'/js/bootstrapvalidator.min.js', array('jquery'), false, true);
	wp_localize_script( 'form-validate', 'ajaxObj', 
		array(
